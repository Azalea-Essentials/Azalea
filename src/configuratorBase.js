...
export function openConfigUI(player, configOptions, title, configTable = "Config") {
    ...
    // } else {
    //     let slotCount = 9*(Object.keys(configOptions).length/9);
    //     let mainForm = new ChestFormData(slotCount.toString());
    ...
    //             i2,
    //             key,
    //             configOptions[key].chestDescription ? configOptions[key].chestDescription : [],
    //             configOptions[key].icon ? configOptions[key].icon : "textures/azalea_icons/Info"
    //         );
    //         // keyAssociations.push([i2, key]);
    //         // mainForm.button(key, configOptions[key].icon, (player, i) => {
    //         //     if (configOptions[key].type)
    //         //         if (configOptions[key].type == "func" && configOptions[key].options[0].fn) {
    //         //             configOptions[key].options[0].fn(player, i);
