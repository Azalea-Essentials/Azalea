...
uiManager.addUI("Azalea1.1/AuctionHouse/Root/AllAuctions/ViewAuction", (player, auctionIndex) => {
...
uiManager.addUI("Azalea1.1/AuctionHouse/Root/AllAuctions", player => {
    let actionForm = new ActionForm();
...
uiManager.addUI("Azalea1.1/AuctionHouse/Root/CreateAuction/Setup", (player, itemStack) => {
...
uiManager.addUI("Azalea1.1/AuctionHouse/Root/CreateAuction", player => {
    let actionForm = new ActionForm();
...
uiManager.addUI("Azalea1.1/AuctionHouse/Root", player => {
    let actionForm = new ActionForm();
