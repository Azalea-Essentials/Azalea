...
export class Database {
  ...
  get(key, defaultResult = "") {
    try {
      ...
      return str.startsWith("OBJECT:") ? JSON.parse(str.substring("OBJECT:".length)) : str.startsWith("NUMBER:") ? parseInt(str.substring("NUMBER:".length)) : str == "BOOL:true" ? true : str == "BOOL:false" ? false : str;
    } catch (e) {
      return defaultResult;
    }
  }
