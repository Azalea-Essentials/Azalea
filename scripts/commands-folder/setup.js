...
export default function () {
  new CommandBuilder("setup").category("Help Center").desc("Easily setup shit with a nice UI").requiresAdmin(true).deprecated().callback(({
    msg,
    response
  }) => {
    ...
    let interval = system.runInterval(() => {
      ...
      if (x != msg.sender.location.x || y != msg.sender.location.y || z != msg.sender.location.z) {
        ...
        let opts1 = ["#HT(staffchat,#BC[#NCStaffChat#BC] ,)§r#BC[#RC#R(§r#BC] [§r#RC)§r#BC] §r#NC#P #BC#DRA §r#MC#M", "#BC[#RC#R(§r#BC] §r#BC[§r#RC)§r#BC] §r#BC<#NC#P§r#BC> §r#MC#M"];
        let opts1_display = ["Default", "Testing"];
